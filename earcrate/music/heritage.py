...
MUSIC_BUFFALO_HARVEST: tuple[dict[str, Any], ...] = (
    ...
    {
        "organ": "cephalopod_observation_ledger_and_song_genome",
        "sources": ["earcrate.reader", "ObservationLedger", "SongGenome", "recurrence and source evidence"],
        "destination": "branch-isolated sensory evidence and recording-derived musical identity",
        "disposition": "preserve",
        "reason": "audio inference must retain exact PCM custody, competing observations, recurrence, and source lineage without consulting score answers",
    },
    {
        "organ": "mixscore_independent_source_transports",
        "sources": ["earcrate.mix", "MixScore", "per-deck execution ledgers"],
        "destination": "source-transport realization beside MIDI and sealed-rack execution",
        "disposition": "preserve",
    ...
    },
    {
        ...
        "disposition": "preserve",
        "reason": "organ-level success must not be laundered into thesis-level success; score, audio, composition, realization, review, and evolution need one explicit receipt",
    },
    {
