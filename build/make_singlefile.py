...
ORDER = ["tastespec/profiles.py", "tastespec/remix_builder.py", "core/deps.py", "core/util.py", "core/wavinfo.py", "analyze/decode.py", "deck/dsp.py",
         ...
         "live/model.py", "live/operators.py", "live/planner.py", "live/planner_fix.py", "live/engine.py", "live/runtime.py", "live/runtime_fix.py", "live/crate.py", "live/stream.py", "live/playback.py", "live/cli.py",
