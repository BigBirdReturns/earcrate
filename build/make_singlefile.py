...
ORDER = ["tastespec/profiles.py", "tastespec/remix_builder.py", "core/deps.py", "core/util.py", "core/wavinfo.py", "analyze/decode.py", "deck/dsp.py",
         ...
         "floor/model.py", "floor/release.py", "floor/_governance_common.py", "floor/_governance_campaign.py", "floor/_governance_decision.py", "floor/_governance_publish.py", "floor/release_governance.py", "floor/schema.py", "floor/registry.py", "floor/adapters.py", "floor/catalog.py", "floor/protocol.py", "floor/tournament.py", "floor/interop.py", "floor/reference.py", "floor/gaps.py", "floor/cli.py",
